...
/**
 * Filtro que extrai o Bearer token do cabeÃ§alho Authorization, valida e popula
 * o SecurityContext com o usuÃ¡rio autenticado. Apenas access tokens sÃ£o aceitos.
 */
@Component
